    ...
    return (
        ...
        >
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {benefits.map((benefit, idx) => (
                            <div
                                key={idx}
                                className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/[0.07] group backdrop-blur-sm"
                            >
            ...
            <section className="w-full px-6 py-20 md:py-32 relative overflow-hidden z-10 border-t border-white/10">
                <div className="absolute inset-0 bg-gradient-to-br from-[#712CF9]/20 via-[#D63384]/20 to-[#FF1B6B]/20"></div>
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,27,107,0.1),transparent_50%)]"></div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, idx) => (
                            <div
                                key={idx}
                                className="rounded-2xl bg-white/5 border border-white/10 overflow-hidden transition-all hover:border-white/20 backdrop-blur-sm"
                            >
                                <button
            ...
            <section className="w-full px-6 py-20 md:py-32 relative overflow-hidden z-10 border-t border-white/10">
                ...
                <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
                    <div className="relative w-full max-w-md aspect-square">
                        {/* Globe */}
                        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#712CF9]/30 via-[#D63384]/30 to-[#FF1B6B]/30 blur-3xl animate-pulse"></div>
                        <div className="absolute inset-8 rounded-full bg-gradient-to-br from-[#712CF9] via-[#D63384] to-[#FF1B6B] opacity-20"></div>

                        {/* Grid lines */}
                        <div className="absolute inset-0 rounded-full border-2 border-white/10"></div>
                        <div className="absolute inset-0 rounded-full border-2 border-white/5 scale-75"></div>
                        <div className="absolute inset-0 rounded-full border-2 border-white/5 scale-50"></div>

                        {/* Horizontal lines */}
                        <div className="absolute top-1/4 left-0 right-0 h-[2px] bg-white/5"></div>
                        <div className="absolute top-1/2 left-0 right-0 h-[2px] bg-white/10"></div>
                        <div className="absolute top-3/4 left-0 right-0 h-[2px] bg-white/5"></div>
...
const Affiliate = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            {/* Hero Section */}
            <section
                className="min-h-[85vh] w-full flex flex-col items-center justify-center space-y-8 px-6 py-20 relative overflow-hidden"
                style={{
                    backgroundImage: `url(${heroImage})`,
                    backgroundPosition: 'center',
                    backgroundSize: 'cover',
            ...
            {/* Commission Tiers Section */}
            <section className="w-full px-6 py-20 md:py-32 bg-black/40 backdrop-blur-sm border-t border-white/10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 space-y-4">
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#712CF9] via-[#D63384] to-[#FF1B6B]">
            ...
            {/* Why It's a Win-Win Section */}
            <section className="w-full px-6 py-20 md:py-32 border-t border-white/10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 space-y-4">
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white">
                            Why Partner With Us?
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {benefits.map((benefit, idx) => (
                            <div
                                key={idx}
                                className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/[0.07] group"
                            >
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#712CF9] to-[#FF1B6B] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <benefit.icon className="w-8 h-8 text-white" />
                                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        {infoCards.map((card, idx) => (
                            <div
                                key={idx}
                                className={`relative p-8 md:p-10 rounded-3xl border border-white/10 bg-gradient-to-br ${card.gradient} overflow-hidden group hover:border-white/20 transition-all`}
                            >
                                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-white/5 to-transparent rounded-full blur-3xl"></div>
            ...
            {/* CTA Section */}
            <section className="w-full px-6 py-20 md:py-32 relative overflow-hidden border-t border-white/10">
                <div className="absolute inset-0 bg-gradient-to-br from-[#712CF9]/20 via-[#D63384]/20 to-[#FF1B6B]/20"></div>
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,27,107,0.1),transparent_50%)]"></div>
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 max-w-3xl mx-auto">
                        {[
                            ...
                            <div key={idx} className="flex flex-col items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/10">
                                <item.icon className="w-8 h-8 text-[#FF1B6B]" />
                                <span className="text-xs text-gray-400 text-center font-medium">{item.label}</span>
                            </div>
                        ))}
